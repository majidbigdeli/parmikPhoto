...
{
    public class PostalCardF
    {
        private List<Bitmap> cards;
        String fontName;
        FontFamily ff;
        private string p;
        public PostalCardF(string workingDir)
        {
            try
            {
                int cardNumbers = 6;
        ...
        private static PostalCardF _postal;
        private static object syncRoot = new Object();
        public static PostalCardF Instance(string dir)
        {
            if (_postal == null)
            {
                lock (syncRoot)
