...
using System.Linq;
using System.Web;
namespace majidParmikPhoto.Utility
{
    public class PostalHappyCard
    {
        ...
        FontFamily ff;
        private string p;
        public PostalHappyCard(string workingDir)
        {
            try
            {
                int cardNumbers = 6;
        ...
        private static PostalHappyCard _postal;
        private static object syncRoot = new Object();
        public static PostalHappyCard Instance(string dir)
        {
            if (_postal == null)
            {
                lock (syncRoot)
                {
                    if (_postal == null)
                        _postal = new PostalHappyCard(dir);
                }
                _postal = new PostalHappyCard(dir);
            }
